...
void STSComponentTest::solveODERK4_Prob1()
{
  QBENCHMARK
  {
    ...
    while(t + dt < maxt)
    {
      solver.solve(&y, 1, t, dt, &y_out, &STSComponentTest::derivativeProb1, nullptr);
...
void STSComponentTest::solveODERKQS_Prob1()
{
...
void STSComponentTest::solveODEAdam_Prob1()
{
...
void STSComponentTest::solveODEBDF_Prob1()
{
...
void STSComponentTest::solveODERK4_Prob2()
{
  //  printf("RK4\n");
  ...
  QBENCHMARK
  {
    ...
    while(t + dt < maxt)
    {
      solver.solve(&y, 1, t, dt, &y_out, &STSComponentTest::derivativeProb2, nullptr);
...
void STSComponentTest::solveODERKQS_Prob2()
{
  //  printf("RKQS\n");
...
void STSComponentTest::solveODEAdam_Prob2()
{
  //  printf("RKQS\n");
...
void STSComponentTest::solveODEBDF_Prob2()
{
  //  printf("RKQS\n");
...
//void STSComponentTest::versteegCase1_Upwind()
//{
//QBENCHMARK_ONCE
//  {
...
//void STSComponentTest::versteegCase1_Central()
//{
//QBENCHMARK_ONCE
//  {
//    std::list<std::string> errors;
...
//void STSComponentTest::versteegCase1_Hybrid()
//{
//QBENCHMARK_ONCE
//  {
//    std::list<std::string> errors;
...
//void STSComponentTest::versteegCase2_Upwind()
//{
//  QBENCHMARK_ONCE
//  {
//    std::list<std::string> errors;
...
//void STSComponentTest::versteegCase2_Central()
//{
//  QBENCHMARK_ONCE
//  {
//    std::list<std::string> errors;
...
//void STSComponentTest::versteegCase2_Hybrid()
//{
//  QBENCHMARK_ONCE
//  {
...
void STSComponentTest::derivativeProb1(double t, double y[], double dydt[], void *userData)
{
  dydt[0] = t * pow(y[0],3) / sqrt(1 + t * t);
}

double STSComponentTest::problem1(double t)
{
  return -1.0 / sqrt(3.0 - 2.0 * sqrt(1+t*t));
}

void STSComponentTest::derivativeProb2(double t, double y[], double dydt[], void* userData)
{
  dydt[0] = (3 * t*t + 4 * t - 4)/(2 * y[0] - 4);
}

double STSComponentTest::problem2(double t)
{
