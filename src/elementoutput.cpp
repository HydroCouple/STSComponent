    ...
    case SoluteConc:
      {
        ...
        {
          Element *element = m_component->modelInstance()->getElement(i);
          double value = element->soluteConcs[m_soluteIndex].value;
          setValue(currentTimeIndex,i,&value);
        }
      }
      break;
    ...
    case Width:
      {
        ...
        {
          Element *element = m_component->modelInstance()->getElement(i);
          double value = element->width * element->beta;
          setValue(currentTimeIndex,i,&value);
        }
      }
      break;
    ...
    case MCHeatFlux:
      {
        ...
        {
          Element *element = m_component->modelInstance()->getElement(i);
          double value = element->mcHeatExchangeFlux;
          setValue(currentTimeIndex,i,&value);
        }
      }
      break;
    case MCSoluteFlux:
      {
        ...
        {
          Element *element = m_component->modelInstance()->getElement(i);
          double value = element->mcSoluteExchangeFlux[m_soluteIndex];
          setValue(currentTimeIndex,i,&value);
        }
      }
      break;
